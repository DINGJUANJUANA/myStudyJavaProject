...
$(function(){
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel : [
            ...
            {label: '用户姓名姓名/企业名称', name: 'realname', width: 80},
            {label: '注册手机号', name: 'mobile', width: 80},
            {label: '用户角色', name: 'userType', width: 100},
            {label: '开户时间', name: 'createTime', width: 140},
            {label: '账面总余额', name: 'totalAmount', width: 100},
...
function showInfo(id) {
    ...
    $("#merchantUserType").text(merchantAccount.userType);
